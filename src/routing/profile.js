...
profilerouter.patch("/user/update/:userid",async (req,res)=>
    {
        const data = req.body;
        try{
            ...
            const after = await User.findByIdAndUpdate(req.params?.userid,data,{returnDocument:"after",runValidators:true}); // returns the user data before deletion .
